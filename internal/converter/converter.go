	...
	if table.IngestionConfig.StreamIngestionConfig.StreamConfigMaps != nil {
		for _, streamConfig := range table.IngestionConfig.StreamIngestionConfig.StreamConfigMaps {
			streamConfigs = append(streamConfigs, &models.StreamConfig{
				...
				StreamKafkaDecoderPropSchemaRegistryMaxRetries:                   types.StringValue(streamConfig.StreamKafkaDecoderPropSchemaRegistryMaxRetries),
				StreamKafkaDecoderPropSchemaRegistryRetriesMaxWaitMs:             types.StringValue(streamConfig.StreamKafkaDecoderPropSchemaRegistryRetriesMaxWaitMs),
				StreamKafkaDecoderPropSchemaRegistryRetriesMaxWait:               types.StringValue(streamConfig.StreamKafkaDecoderPropSchemaRegistryRetriesMaxWait),
