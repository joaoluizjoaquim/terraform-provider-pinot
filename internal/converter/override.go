	...
	if plan.IngestionConfig.StreamIngestionConfig.StreamConfigMaps != nil {
		...
		for _, streamConfig := range plan.IngestionConfig.StreamIngestionConfig.StreamConfigMaps {
			streamConfigs = append(streamConfigs, model.StreamConfig{
				...
				StreamKafkaDecoderPropSchemaRegistryMaxRetries:                   streamConfig.StreamKafkaDecoderPropSchemaRegistryMaxRetries.ValueString(),
				StreamKafkaDecoderPropSchemaRegistryRetriesMaxWaitMs:             streamConfig.StreamKafkaDecoderPropSchemaRegistryRetriesMaxWaitMs.ValueString(),
				StreamKafkaDecoderPropSchemaRegistryRetriesMaxWait:               streamConfig.StreamKafkaDecoderPropSchemaRegistryRetriesMaxWait.ValueString(),
